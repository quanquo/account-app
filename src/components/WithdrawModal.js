...
import './DepositModal.css'; // Wir können das gleiche CSS wiederverwenden

function WithdrawModal({ isOpen, onClose, onSubmit, accountNumber }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result && result.success) {
        ...
        setError(result?.message || 'Auszahlung fehlgeschlagen');
      }
    } catch (err) {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="button-group">
              ...
              <button 
                ...
                disabled={isSubmitting}
              >
                {isSubmitting ? 'Wird verarbeitet...' : 'Auszahlen'}
              </button>
            </div>
          </form>
        )}
